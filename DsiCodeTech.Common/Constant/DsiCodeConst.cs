...
namespace DsiCodeTech.Common.Constant
{
    public static class DsiCodeConst
    {
        ...
        public static readonly string RESULT_CANCEL_INVOIVE_ERROR_ID = "POS-SYSADM-117";
        public static readonly string RESULT_CANCEL_INVOIVE_ERROR = "Se presento un error al intentar cancelar con SW Sapien, consulte al administrador.";

        public static readonly string RESULT_CANCEL_INVOIVE_SUCCESS = "Factura cancelada correctamente.";
        ...
        public static readonly string RESULT_EXITS_OFFER_ERROR = "El artículo que desea ofertar ya existe en otra oferta.";

        public static readonly string RESULT_PRINCIPAL_OFFER_ERROR_ID = "POS-SYSADM-116";
        public static readonly string RESULT_PRINCIPAL_OFFER_ERROR = "El artículo que desea ofertar debé ser de tipo principal.";

        public static readonly string ERROR_NO_AUTHORIZE_PEDIDO_MESSAGE_ID = "POS-SYSADM-117";
        public static readonly string ERROR_NO_AUTHORIZE_PEDIDO_MESSAGE = "Los pedidos que tienen estatus autorizado o no autorizado, no se pueden editar.";
        ...
        public static readonly string PDF_DOWNLOAD_CONTENT_TYPE = "application/pdf";
        public static readonly string PDF_FILE_IMAGE = @"C:\suPlaza\config\images\plaza.png";
        public static readonly string PDF_FONT_ARIAL = @"C:\Windows\Fonts\arial.ttf";
        public static readonly string PDF_FONT_SANS = @"C:\suPlaza\config\fonts\SourceSansPro-Regular.ttf";
        public static readonly string PDF_FONT_SANS_BOLD = @"C:\suPlaza\config\fonts\SourceSansPro-Bold.ttf";
        ...
        public static readonly string PIEZA = "Pza";
        public static readonly string CAJA = "Cja";
        public static readonly string PAQUETE = "Paq";

        public static readonly string ERROR = "error";
        public static readonly string SUCCESS = "success";

        public static readonly string STATUS_TODOS = "todos";
        public static readonly string AUTORIZADO = "autorizado";
        public static readonly string NO_AUTORIZADO = "no autorizado";

        public const string ACTUAL = "actual";
        public const string PASADO = "pasado";
